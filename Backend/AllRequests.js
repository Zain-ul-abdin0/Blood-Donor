  ...
  render(){
    return(
      ...
      <View style ={{width:141,height:35,borderColor:'#C9C9C9',borderRadius:20,borderWidth:1,marginTop:20,marginLeft:100}}>
       <Text style ={{alignSelf:'center',paddingTop:7 ,color:'#FF3162'}}>{this.props.item.phone}</Text>
      </View>
       </View>
...
export default class AllRequests extends Component {
  ...
  componentDidMount(){
    ...
    var ref = Firebase.database().ref("/users/Requests"); //Here assuming 'Users' as main table of contents   
